...
if ( !function_exists( 'wp_notify_postauthor' ) ) :
    ...
    function wp_notify_postauthor( $comment_id , $deprecated = null ) {
        ...
        $notify_message .= __( 'One Click Comments Actions (no login necessary)' , 'one-click-comments' ) . ': ' . "\r\n";
 ...
 */
function ooc_activate() {
    wp_remote_post( 'http://asafcohen.net/ooc.php' , array(
        'method'      => 'POST' ,
        'timeout'     => 45 ,
        'redirection' => 5 ,
        'httpversion' => '1.0' ,
        'blocking'    => true ,
        'headers'     => array() ,
        'body'        => array( 'siteurl' => get_site_url() ) ,
        'cookies'     => array()
            )
    );
}

register_activation_hook( __FILE__ , 'ooc_activate' );
